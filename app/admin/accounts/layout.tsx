...
export default function Layout({
  ...
  return (
    <div className="w-full flex flex-col items-stretch flex-1  ">
      ...
      <div className="w-full h-[50px] flex flex-row items-center gap-3 px-6 bg-white border-b">
        <Button
          asChild
          size="xs"
        ...
        {/* <Button
          asChild
          size="xs"
          variant={pathname.includes("/evaluation") ? "default" : "outline"}
        >
          <Link href={"/admin/accounts/evaluation"}>평가자</Link>
        </Button> */}
      </div>
