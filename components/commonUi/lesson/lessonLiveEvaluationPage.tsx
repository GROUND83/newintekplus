...
import { getLessonDetail } from "@/components/commonActions/commonActions";
import PerformEvaluationLive from "./component/performEvaluationlive";

export default function LessonLiveEvaluationPage() {
